...
| **Stack**|
|<span style="color:orange">STACK|(-)| | Multiple of this effect is allow to be applied. The option "Allow Duplicate Effects" must be set to off</span>|5E|
| **Turn** |
|<span style="color:blue">TURNAS|(-)| | ACTIVATE effect on the START of the Actor’s turn</span>|CoreRPG|
