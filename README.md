...
* **DMGAT** will cause an effect to ACTIVATE when the PC/NPC takes damage.

* **DMGDT** will cause an effect to DEACTIVATE when the PC/NPC takes damage. Allows items like Cloak of Displacement to function properly.
